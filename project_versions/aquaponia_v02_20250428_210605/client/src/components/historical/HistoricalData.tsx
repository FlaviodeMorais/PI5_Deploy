          ...
          {processedData && processedData.stats && (
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 mt-4 sm:mt-6">
              <div className="bg-[#0f172a] border border-white/5 p-3 sm:p-4 rounded-md">
                ...
                <p className="text-base sm:text-xl font-semibold">{formatNumber(processedData.stats.temperature.avg, 2)}°C</p>
              </div>
              <div className="bg-[#0f172a] border border-white/5 p-3 sm:p-4 rounded-md">
                <p className="text-xs sm:text-sm text-gray-400 mb-1">Mínima</p>
                <p className="text-base sm:text-xl font-semibold">{formatNumber(processedData.stats.temperature.min, 2)}°C</p>
              </div>
              <div className="bg-[#0f172a] border border-white/5 p-3 sm:p-4 rounded-md">
                <p className="text-xs sm:text-sm text-gray-400 mb-1">Máxima</p>
                <p className="text-base sm:text-xl font-semibold">{formatNumber(processedData.stats.temperature.max, 2)}°C</p>
              </div>
              <div className="bg-[#0f172a] border border-white/5 p-3 sm:p-4 rounded-md">
                <p className="text-xs sm:text-sm text-gray-400 mb-1">Desvio Padrão</p>
                <p className="text-base sm:text-xl font-semibold">±{formatNumber(processedData.stats.temperature.stdDev || 0, 2)}°C</p>
              </div>
            </div>
          )}
        </div>
        ...
        <div className="bg-[#0f172a] rounded-lg shadow-md p-4 sm:p-6 mb-6 sm:mb-8 border border-white/5">
          ...
          {processedData && processedData.stats && (
            <div className="grid grid-cols-2 md:grid-cols-4 gap-3 sm:gap-4 mt-4 sm:mt-6">
              <div className="bg-[#0f172a] border border-white/5 p-3 sm:p-4 rounded-md">
                <p className="text-xs sm:text-sm text-gray-400 mb-1">Média</p>
                <p className="text-base sm:text-xl font-semibold">{formatNumber(processedData.stats.level.avg, 2)}%</p>
              </div>
              <div className="bg-[#0f172a] border border-white/5 p-3 sm:p-4 rounded-md">
                <p className="text-xs sm:text-sm text-gray-400 mb-1">Mínima</p>
                <p className="text-base sm:text-xl font-semibold">{formatNumber(Math.max(0, processedData.stats.level.min), 2)}%</p>
              </div>
              <div className="bg-[#0f172a] border border-white/5 p-3 sm:p-4 rounded-md">
                <p className="text-xs sm:text-sm text-gray-400 mb-1">Máxima</p>
                <p className="text-base sm:text-xl font-semibold">{formatNumber(Math.min(100, processedData.stats.level.max), 2)}%</p>
              </div>
              <div className="bg-[#0f172a] border border-white/5 p-3 sm:p-4 rounded-md">
                <p className="text-xs sm:text-sm text-gray-400 mb-1">Desvio Padrão</p>
                <p className="text-base sm:text-xl font-semibold">±{formatNumber(processedData.stats.level.stdDev || 0, 2)}%</p>
              </div>
            </div>
          )}
        </div>
